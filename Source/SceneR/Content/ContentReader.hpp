...
namespace SceneR
{
    namespace Content
    {
        ...
        template<>
        inline SceneR::Math::Matrix ContentReader::convert(const std::vector<json11::Json>& values) const noexcept
        {
        ...
        template<>
        inline SceneR::Math::Quaternion ContentReader::convert(const std::vector<json11::Json>& values) const noexcept
        {
        ...
        template<>
        inline SceneR::Math::Vector2 ContentReader::convert(const std::vector<json11::Json>& values) const noexcept
        {
            return { values[0].number_value()
                   , values[1].number_value() };
        }
        ...
        template<>
        inline SceneR::Math::Vector3 ContentReader::convert(const std::vector<json11::Json>& values) const noexcept
        {
            return { values[0].number_value()
                   , values[1].number_value()
                   , values[2].number_value()};
        ...
        template<>
        inline SceneR::Math::Vector4 ContentReader::convert(const std::vector<json11::Json>& values) const noexcept
        {
            return { values[0].number_value()
                   , values[1].number_value()
                   , values[2].number_value()

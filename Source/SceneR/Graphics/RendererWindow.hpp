...
namespace SceneR
{
    namespace Graphics
    {
        ...
        public:
            ...
            DisplayDevice* display_device() const noexcept;

            DisplaySurface* display_surface() const noexcept;
        ...
        private:
            ...
            std::unique_ptr<DisplayDevice>  _displayDevice  { nullptr };
            std::unique_ptr<DisplaySurface> _displaySurface { nullptr };

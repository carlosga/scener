...
{
    auto a   = Vector4 { -2.0f, 3.0f, SceneR::Math::max_value, SceneR::Math::nan};
    auto div = 0.0f;
...
{
    auto a = Vector4 { 0.047f, -3.0f, SceneR::Math::negative_infinity, SceneR::Math::min_value};
    auto b = Vector4 { };
    ...
    EXPECT_TRUE(SceneR::Math::is_negative_infinity(actual.w));
}
...
TEST_F(Vector4Test, Add)
{
    ...
    auto v3 = v1 + v2;
    auto v5 = Vector4 { -1.0f, 0.0f, 0.0f, SceneR::Math::nan};
    auto v4 = v1 + v5;
    ...
    EXPECT_TRUE(SceneR::Math::is_nan(v4.w));
}
...
{
    auto target = Vector4 { SceneR::Math::nan
                          , SceneR::Math::max_value
                          , SceneR::Math::positive_infinity
                          , SceneR::Math::epsilon};

    EXPECT_TRUE(SceneR::Math::is_nan(target.x));
    EXPECT_TRUE(EqualityHelper::Equal(SceneR::Math::max_value, target.y));
    EXPECT_TRUE(SceneR::Math::is_positive_infinity(target.z));
    EXPECT_TRUE(EqualityHelper::Equal(SceneR::Math::epsilon, target.w));
}
...
{
    Vector4 a { SceneR::Math::nan, 0, 0, 0 };
    Vector4 b { 0, SceneR::Math::nan, 0, 0 };
    Vector4 c { 0, 0, SceneR::Math::nan, 0 };
    Vector4 d { 0, 0, 0, SceneR::Math::nan};
...
TEST_F(Vector4Test, Abs)
{
    ...
    Vector4 v3 = Vector4::abs(Vector4 { SceneR::Math::positive_infinity, 0.0f, SceneR::Math::negative_infinity, SceneR::Math::nan });
    ...
    EXPECT_TRUE(SceneR::Math::positive_infinity == v3.x);
    EXPECT_TRUE(0.0f == v3.y);
    EXPECT_TRUE(SceneR::Math::positive_infinity == v3.z);
    EXPECT_TRUE(SceneR::Math::is_nan(v3.w));
}
...
TEST_F(Vector4Test, SquareRoot)
{
    ...
    EXPECT_TRUE(SceneR::Math::is_nan(Vector4::square_root(v1).x));
}

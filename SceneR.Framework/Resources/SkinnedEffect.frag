...
layout(index = 0) subroutine (PixelShader) vec4 PSSkinnedVertexLighting()
{
    PSInputTx pin;
    SetPSInputTxParams;
...
layout(index = 1) subroutine (PixelShader) vec4 PSSkinnedVertexLightingNoFog()
{
    PSInputTx pin;
    SetPSInputTxParams;
...
layout(index = 2) subroutine (PixelShader) vec4 PSSkinnedPixelLighting()
{

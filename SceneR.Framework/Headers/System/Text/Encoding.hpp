...
namespace System
{
    namespace Text
    {
        ...
        public:
             ...
             */
            virtual std::size_t GetMaxByteCount(const std::size_t& charCount) = 0;
             ...
             */
            virtual std::size_t GetMaxCharCount(const std::size_t& byteCount) = 0;

            /**
             * When overridden in a derived class, returns a sequence of bytes that specifies
             * the encoding used.
             */
            virtual std::vector<std::uint8_t> GetPreamble() const = 0;

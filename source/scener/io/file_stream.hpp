...
#ifndef SCENER_IO_FILE_STREAM_HPP
#define SCENER_IO_FILE_STREAM_HPP
...
namespace scener::io
{
    ...
    {
    public:
        /// Initializes a new instance of the file_stream class with the specified and opening mode.
        /// \param path a relative or absolute path for the file that the current file_stream object will encapsulate.
        /// \param mode a constant that determines how to open or create the file.
        file_stream(const std::string& path, const std::ios::openmode& mode = std::ios::in | std::ios::binary) noexcept;

        /// Releases all resources being used by this file_stream.
...
#endif // SCENER_IO_FILE_STREAM_HPP
